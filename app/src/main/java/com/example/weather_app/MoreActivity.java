...
public class MoreActivity extends AppCompatActivity implements View.OnClickListener{
    TextView bgTv,cacheTv,versionTv,shareTv,aboutTv,about;
    RadioGroup exbgRg;
    ImageView backIv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        aboutTv = findViewById(R.id.more_tv_about);
        about = findViewById(R.id.more_tv_developer);
